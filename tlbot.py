...
def greet(message):
    ...
    bot.send_message(
        message.chat.id, text=str("<b>Enter your username and secrete key used to create account on <a href='http://"+host_id+":5000/'>Leavemeamessage</a> website in the format</b>"), parse_mode='HTML')
